# admin-exportable-reports-v1 Specification

## Purpose

Definir el catálogo de reportes administrativos V1 exportables a Excel con acceso ADMIN-only. Reemplaza la UI de debug analytics offline por reportes server-backed con filtros, DataTable y exportación XLSX client-side.
