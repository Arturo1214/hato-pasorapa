...
public class AnimalHealthEvent {
    ...
    @Column(name = "health_event_type", nullable = false, length = 40)
    ...
    public AnimalHealthEventType getHealthEventType() {
        return healthEventType;
    }

    public void setHealthEventType(AnimalHealthEventType healthEventType) {
