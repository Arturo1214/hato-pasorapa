...
@Entity
@Table(name = "animal_reproduction_events")
public class AnimalReproductionEvent {
    ...
    @Column(name = "reproduction_event_type", nullable = false, length = 40)
    ...
    public AnimalReproductionEventType getReproductionEventType() {
        return reproductionEventType;
    }

    public void setReproductionEventType(AnimalReproductionEventType reproductionEventType) {
        this.reproductionEventType = reproductionEventType;
    }
