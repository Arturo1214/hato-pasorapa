...
public class AnimalHealthEvent {
    ...
    private AnimalHealthEventType healthEventType;
    ...
    public AnimalHealthEventType getHealthEventType() { return healthEventType; }
    public void setHealthEventType(AnimalHealthEventType healthEventType) { this.healthEventType = healthEventType; }
