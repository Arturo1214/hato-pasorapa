# Delta for herd-descriptive-indicators-projection-v2
...
(Previously: descriptive-only and bounded windows were required, but explanatory metadata for decision-support signals was not explicit.)
