...
@Entity
@Table(name = "animal_event_logs")
public class AnimalEventLog {
    ...
    private AnimalEventCategory eventCategory;
    ...
    @Column(name = "visit_id", length = 80)
    private String visitId;

    @Column(name = "parent_visit_id", length = 80)
    private String parentVisitId;

    @Column(name = "visit_status", length = 30)
    private String visitStatus;

    @Column(name = "protocol_status", length = 30)
    ...
    public AnimalEventCategory getEventCategory() { return eventCategory; }
    public void setEventCategory(AnimalEventCategory eventCategory) { this.eventCategory = eventCategory; }
    ...
    public String getParentVisitId() { return parentVisitId; }
    public void setParentVisitId(String parentVisitId) { this.parentVisitId = parentVisitId; }
