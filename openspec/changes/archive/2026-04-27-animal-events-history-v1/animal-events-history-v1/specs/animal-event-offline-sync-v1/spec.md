...
The system MUST sync queued events through existing push/pull channel and MUST enforce idempotency by `operationId` so duplicate replays do not create duplicated ledger rows nor duplicated projection effects.
